...
namespace MicronBEAssyUserInterface.ProdGantt
{
    public class Constants
    {
        ...
        public const string TABLE_MCPBOM = "McpBom";

        public const string COLUMN_LINE_ID = "LINE_ID";
        public const string COLUMN_EQP_ID = "EQP_ID";
        public const string COLUMN_STEP_GROUP = "STEP_GROUP";
        public const string COLUMN_QTY = "QTY";
        public const string COLUMN_TOTAL = "TOTAL";
        public const string COLUMN_AO_PROD = "AO_PROD";
        public const string COLUMN_PRODUCT = "PRODUCT";
        public const string COLUMN_MCP_SEQ = "MCP_SEQ";
        public const string COLUMN_STEP_ID = "STEP_ID";
        ...
        public const string COLUMN_FINAL_PROD_ID = "FINAL_PROD_ID";
